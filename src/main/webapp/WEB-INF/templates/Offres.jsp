		...
		<div class="profile">
			...
			<div class="profile-container">
				...
				<div class="profile-content  ">
					...
					<c:forEach items="${offrelist}" var="offre">
								...
								<div class="ml-3 w-100">
									...
									<div
										...
										<div class="d-flex flex-column">
											<span class="articles">Date debut</span> <span
												class="number1"><c:out value="${offre.dateDebut}" /></span>
										</div>
										<div class="d-flex flex-column">
											<span class="followers">Date fin</span> <span class="number2"><c:out
													value="${offre.dateFin}" /></span>
										</div>
										<div class="d-flex flex-column">
											<span class="rating">Nombre d'apprenant</span> <span
												class="number3"><c:out
													value="${offre.nombreApprenant}" /></span>
										</div>
										<div class="d-flex flex-column">
											<span class="rating">Description</span> <span class="number3"><c:out
													value="${offre.description}" /></span>
										</div>
									</div>
									<div class="button mt-2 d-flex flex-row align-items-center">
										<a class="btn btn-sm btn-danger w-50 "
											href="<c:url value='/deleteoffre/${offre.idOffre}'/> ">Supprimer</a>
									</div>
								</div>
							</div>
						</div>
