...
<%
    ...
    <div class="profile">
        <div class="profile-header">
            ...
            <div class="profile-header-content">
                ...
                <ul class="profile-header-tab nav nav-tabs nav-tabs-v2">
                    ...
                    <li class="nav-item">
                        <a href="demandesinscrit" class="nav-link active" data-toggle="tab">
        ...
        <div class="profile-container">
         ...
         <c:forEach items="${inscrilist}" var="apprenant">
                                ...
                                <div class="list-group">
                                    ...
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <div class="flex-fill pl-3 pr-3">
                                            <div><a href="#" class="text-dark font-weight-600">Nom : <c:out value="${apprenant.nomUtilisateur}" /></a></div>
                                            <div class="text-dark font-weight-600">Prénom : <c:out value="${apprenant.prenomUtilisateur}" /></div>
                                           
                                            <div class="text-muted fs-13px">Email : <c:out value="${apprenant.emailUtilisateur}" /></div>
                                        </div>
                                        <div style="margin-right:2%">
                                        <a  class="btn btn-success"  href="<c:url value='/modifapprenant/${apprenant.idUtilisateur}'/> ">Accepté</a> 
                                       </div>
                                       <div>
                                        <a  class="btn btn-danger "  href="<c:url value='/deleteapprenant/${apprenant.idUtilisateur}'/> ">Refusé</a>
                                   	 </div>
                                    </div>
                                </div>
                            </div>
